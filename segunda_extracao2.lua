...
print("Added Layer7: ti_22765_wgs84_21s.shp")
...
print("Added Layer8: embargo_2005a2014_wgs84_21s_fix.shp")
...
print("Added Layer9: AMZ_2014_areaaberta.shp")
...
print("Added Layer12: Area_imovel_CAR_Itaituba_NP_ALT_UTM_limpo_fix_22765.shp")

l13 = Layer{
	project = proj,
	name = "layer13",
	file = "C:\\Users\\Padrao\\Documents\\fillcell\\2014\\Prodes_2014\\incremento_corteraso_2014_2017_21s_fix_cleaned.shp"
}
print("Added Layer13: incremento_corteraso_2014_2017_21s_fix_cleaned.shp")

l14 = Layer{
	project = proj,
	name = "layer14",
	file = "C:\\Users\\Padrao\\Documents\\fillcell\\2014\\TerraClass\\AMZ_2014_floresta_diss.shp"
}
print("Added Layer14: AMZ_2014_floresta_diss.shp")
...
local fileVector = {"celulas_paraExtracao.shp", "degTodas_2010a2013_fix.shp", "TerraLegal_SigefParticular_wg84_21s_fix.shp", "CAR_Conflitos_UC_AST_Sobrp.shp", "Assentamentos_Oficial_Clip_wgs84_21s.shp", "uc_wgs84_21s_fix.shp", "ti_22765_wgs84_21s.shp", "embargo_2005a2014_wgs84_21s_fix.shp", "AMZ_2014_areaaberta.shp", "AMZ_2014_vegsec.shp", "NaoFloresta_Hidrografia_2017.shp", "Area_imovel_CAR_Itaituba_NP_ALT_UTM_limpo_fix_22765.shp", "incremento_corteraso_2014_2017_21s_fix_cleaned.shp", "AMZ_2014_floresta_diss.shp"}
...
print("Filling incremento_corteraso_2014_2017_21s_fix_cleaned.shp into Cellular Space using area operation")
cs:fill{
	layer = "layer13",
	operation = "area",
...
print("Filling AMZ_2014_floresta_diss.shp into Cellular Space using area operation")
cs:fill{
	layer = "layer14",
	operation = "area",
	attribute = "area_flor",
