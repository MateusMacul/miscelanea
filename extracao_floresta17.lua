...
l2 = Layer{
	project = proj,
	name = "layer2",
	file = "C:\\Users\\Padrao\\Documents\\fillcell\\2014\\Prodes_2014\\PDigital2017_PA__WGS84_fix_clip_FLORESTA_fix_subdividido.shp"
}
print("Added Layer2: PDigital2017_PA__WGS84_fix_clip_FLORESTA_fix_subdividido.shp")

-- Checking EPSGs --
print("\n-- Checking EPSGs--")
local epsgVector = {l1.epsg, l2.epsg}
local fileVector = {"celulas_extraida2.shp", "PDigital2017_PA__WGS84_fix_clip_FLORESTA_fix_subdividido.shp"}
...
print("Filling PDigital2017_PA__WGS84_fix_clip_FLORESTA_fix_subdividido.shp into Cellular Space using area operation")
cs:fill{
	layer = "layer2",
	operation = "area",
	attribute = "flor_17_p",
