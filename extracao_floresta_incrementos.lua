...
l1 = Layer{
	project = proj,
	name = "limit",
	file = "C:\\Users\\Padrao\\Documents\\fillcell\\celulas_extraida.shp"
}
print("Added Cellular Spaced: celulas_extraida.shp")
...
l6 = Layer{
	project = proj,
	name = "layer6",
	file = "C:\\Users\\Padrao\\Documents\\fillcell\\2014\\Prodes_2014\\PDigital2017_PA__WGS84_fix_clip_FLORESTA.shp"
}
print("Added Layer6: PDigital2017_PA__WGS84_fix_clip_FLORESTA.shp")

-- Checking EPSGs --
print("\n-- Checking EPSGs--")
local epsgVector = {l1.epsg, l2.epsg, l3.epsg, l4.epsg, l5.epsg, l6.epsg}
local fileVector = {"celulas_extraida.shp", "PDigital2017_PA__WGS84_fix_clip_icre2014.shp", "PDigital2017_PA__WGS84_fix_clip_icre2015.shp", "PDigital2017_PA__WGS84_fix_clip_icre2016.shp", "PDigital2017_PA__WGS84_fix_clip_icre2017.shp", "PDigital2017_PA__WGS84_fix_clip_FLORESTA.shp"}
...
print("Filling PDigital2017_PA__WGS84_fix_clip_FLORESTA.shp into Cellular Space using area operation")
cs:fill{
	layer = "layer6",
	operation = "area",
	attribute = "flor_17_p",
