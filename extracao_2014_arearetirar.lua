...
l2 = Layer{
	project = proj,
	name = "layer2",
	file = "C:\\Users\\Padrao\\Documents\\fillcell\\2014\\Nuvem_NaoFloresta_Hidrografia_2014.shp"
}
print("Added Layer2: Nuvem_NaoFloresta_Hidrografia_2014.shp")

-- Checking EPSGs --
print("\n-- Checking EPSGs--")
local epsgVector = {l1.epsg, l2.epsg}
local fileVector = {"cell_2km_prodes_declividade2.shp", "Nuvem_NaoFloresta_Hidrografia_2014.shp"}
...
print("Filling Nuvem_NaoFloresta_Hidrografia_2014.shp into Cellular Space using area operation")
cs:fill{
	layer = "layer2",
	operation = "area",
