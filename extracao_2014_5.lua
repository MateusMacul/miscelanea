...
print("Added Layer2: Assentamentos_Oficial_Clip_wgs84_21s.shp")
...
print("Added Layer3: uctodas_wgs84_21s.shp")
...
print("Added Layer4: ti_wgs84_21s.shp")
...
print("Added Layer5: Hidrografia 250000_wgs84_21s.shp")

-- Checking EPSGs --
print("\n-- Checking EPSGs--")
local epsgVector = {l1.epsg, l2.epsg, l3.epsg, l4.epsg, l5.epsg}
local fileVector = {"cell_2km_prodes.shp", "Assentamentos_Oficial_Clip_wgs84_21s.shp", "uctodas_wgs84_21s.shp", "ti_wgs84_21s.shp", "Hidrografia 250000_wgs84_21s.shp"}
